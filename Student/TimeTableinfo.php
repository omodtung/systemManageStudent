...
if (isset($_SESSION['id']) && 
    ...
    if ($_SESSION['role'] == 'Student') {
        ...
        $thissche = getScheduleFromClass($conn,$ma_lop);
                        ...
                        <table class="table table-success  n-table table-hover mx-auto align-middle table-striped-columns">
                            ...
                            <?php foreach ($thissche as  $schedule) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ("Thứ Hai" == $schedule['WorkDate']) ? (($schedule["Class"] == $ma_lop) ? getSubjectBySubject_code(getTeacher($conn,$schedule['TeacherId'])['mamonhoc'],$conn)['subject'] : '') : ''; ?></td>
                                    <td><?php echo ("Thứ Ba" == $schedule['WorkDate']) ? (($schedule["Class"] == $ma_lop) ? getSubjectBySubject_code(getTeacher($conn,$schedule['TeacherId'])['mamonhoc'],$conn)['subject'] : '') : ''; ?></td>
                                    <td><?php echo ("Thứ Tư" == $schedule['WorkDate']) ? (($schedule["Class"] == $ma_lop) ? getSubjectBySubject_code(getTeacher($conn,$schedule['TeacherId'])['mamonhoc'],$conn)['subject'] : '') : ''; ?></td>
                                    <td><?php echo ("Thứ Năm" == $schedule['WorkDate']) ? (($schedule["Class"] == $ma_lop) ? getSubjectBySubject_code(getTeacher($conn,$schedule['TeacherId'])['mamonhoc'],$conn)['subject'] : '') : ''; ?></td>
                                    <td><?php echo ("Thứ Sáu" == $schedule['WorkDate']) ? (($schedule["Class"] == $ma_lop) ? getSubjectBySubject_code(getTeacher($conn,$schedule['TeacherId'])['mamonhoc'],$conn)['subject'] : '') : ''; ?></td>
                                    <td><?php echo ("Thứ Bảy" == $schedule['WorkDate']) ? (($schedule["Class"] == $ma_lop) ? getSubjectBySubject_code(getTeacher($conn,$schedule['TeacherId'])['mamonhoc'],$conn)['subject'] : '') : ''; ?></td>
                                    <td><?php echo ("Chủ Nhật" == $schedule['WorkDate']) ? (($schedule["Class"] == $ma_lop) ? getSubjectBySubject_code(getTeacher($conn,$schedule['TeacherId'])['mamonhoc'],$conn)['subject'] : '') : ''; ?></td>
