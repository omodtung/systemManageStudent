...
if (isset($_SESSION['admin_id']) && isset($_SESSION['role'])) {
    ...
    <body>
    <form method="post" action="req/editScore.php?id=<?= $id ?>">
    ...
    <button style="margin-top: 10px;  margin-right: 2%;" type="submit" class="btn btn-primary position-absolute bottom-2 end-0" data-bs-dismiss="modal" id="Sucsessbtn" onclick="Save()">Save</button>
</form>
