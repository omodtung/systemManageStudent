                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-row pt-3">
                            ...
                            <div class="btn-group" role="group" style="flex-wrap: wrap;">
                                <input type="radio" class="btn-check" name="workdate" value="Thứ Hai" id="btnradio1" autocomplete="off">
                                <label class="btn btn-outline-primary rounded ms-1" for="btnradio1">Thứ Hai</label>
                                <input type="radio" class="btn-check" name="workdate" value="Thứ Ba" id="btnradio2" autocomplete="off">
                                <label class="btn btn-outline-primary rounded ms-1" for="btnradio2">Thứ Ba</label>
                                <input type="radio" class="btn-check" name="workdate" value="Thứ Tư" id="btnradio3" autocomplete="off">
                                <label class="btn btn-outline-primary rounded ms-1" for="btnradio3">Thứ Tư</label>
                                <input type="radio" class="btn-check" name="workdate" value="Thứ Năm" id="btnradio4" autocomplete="off">
                                <label class="btn btn-outline-primary rounded ms-1" for="btnradio4">Thứ Năm</label>
                                <input type="radio" class="btn-check" name="workdate" value="Thứ Sáu" id="btnradio5" autocomplete="off">
                                <label class="btn btn-outline-primary rounded ms-1" for="btnradio5">Thứ Sáu</label>
                                <input type="radio" class="btn-check" name="workdate" value="Thứ Bảy" id="btnradio6" autocomplete="off">
                                <label class="btn btn-outline-primary rounded ms-1" for="btnradio6">Thứ Bảy</label>
                                <input type="radio" class="btn-check" name="workdate" value="Chủ Nhật" id="btnradio7" autocomplete="off">
