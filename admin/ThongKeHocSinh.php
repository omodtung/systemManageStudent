...
if (isset($_SESSION['admin_id']) && isset($_SESSION['role'])) {
    ...
    if ($_SESSION['role'] = 'Admin') {
        ...
        $countFemale = countNumberStudentFemale($conn);
        $countMale = countNumberStudentMale($conn);
        $countTotalTeacher = $countFemale+$countMale;
        $hocLucGioi = countHocLucGioi($conn);
        $hocLucKha =  countHocLucKem($conn)
        //print_r($teachers);
        ...
        <body>
            <div class="sidebar">
                ...
                <ul class="nav-list">
                    ...
                    <li>
                        <a href="studentUI.php">
                            <i class="bx bx-user"></i>
                            <span class="link_name">View List Student</span>
                        </a>
                        <span class="tooltip">List student</span>
                    </li>
                    <li>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="card bg-success">
                                    <div class="card-header">
                                        <h3><a href="teacherNewUI.php" style="color:black;text-decoration: none;"> Total student</a></h3>
                                    </div>
                                    <div class="card-body">
                                        <span class="badge badge-primary text-white"><?php echo ($countFemale+$countMale) ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="card card-warning" style="background-color: red;">
                                    <div class="card-header">
                                        <h3><a href="teacherNewUI.php" style="color:black;text-decoration: none;"> Male Student</a></h3>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-4">
                                ...
                                <div class="card bg-warning">
                                    <div class="card-header">
                                        <h3><a href="teacherNewUI.php" style="color:black;text-decoration: none;"> feMale Studnent</a></h3>
                                    </div>
                                    <div class="card-body">
...
<script>
var xzValues = ["Hoc Luc Gioi", "Hoc Luc Kem"];
var yzValues = [<?=$hocLucGioi?>, <?=$hocLucKha?>];
var barColors = [
  "#b91d47",
  "#00aba9",
  "#2b5797"
